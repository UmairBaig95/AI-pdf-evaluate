...
export default function Sidebar() {
  ...
  return (
    <>
      <div className="w-full md:h-screen md:w-[52px] md:bg-[#F8FAFC] bg-white text-white flex md:flex-col  items-center md:rounded-[16px] px-4 md:px-0 py-2">
        <div className="md:mb-8 w-20 md:w-full">
